...
/** Function block_lite_admin_notice_discount */
function block_lite_admin_notice_discount() {
	if ( ! PAnD::is_admin_notice_active( 'notice-block-lite-discount-30' ) ) {
		return;
	}
	?>

	<div data-dismissible="notice-block-lite-discount-30" class="notice updated is-dismissible">

		<p><?php printf( wp_kses_post( '🍍 Aloha! Mahalo for using Block Lite. We would like to extend a <b>20&#37; discount</b> towards our <a href="%1$s" target="_blank">Blocks Bundle Plugin</a> or any <a href="%2$s" target="_blank">Organic Themes Membership</a>. Just enter the coupon code "LITEUP20" during checkout.', 'block-lite' ), 'https://organicthemes.com/blocks/', 'https://organicthemes.com/pricing/' ); ?></p>
...
add_action( 'admin_notices', 'block_lite_admin_notice_discount', 10 );
